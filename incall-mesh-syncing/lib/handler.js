  ...
  return {
    ...
    add: function (core, resources, opts = {}) {
      return new Promise((resolve, reject) => {
        ...
        // This is the mesh that will sync across participants if it updates using the resources.transaction method.
        // See this being used in renderer.js
        // This is the initial state of the mesh values, so set safe defaults in here
